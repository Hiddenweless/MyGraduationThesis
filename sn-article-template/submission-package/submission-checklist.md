...
- `title-page.tex`: separate title page with author/funding placeholders.
- `sn-article.pdf`: compiled anonymous main manuscript.
- `title-page.pdf`: compiled title page.
- `figures/*.png`: manuscript figures copied from the thesis project and converted for clean compilation.
...
- Final author order and corresponding author.
- Valid email addresses and complete affiliations.
- Funding statement and grant numbers.
- Whether code can be released during double-blind review, and if so, whether to use an anonymized repository.
- Whether the experiment numbers in the thesis are final and can be reported as journal results.
