...
%% ----------------------------------------------------------------------------
\author
    {\ifblindreview ****\else 王腾龙\fi}                        % 作者中文姓名
    {\ifblindreview ****\else WANG Teng-long\fi}                  % 作者英文姓名，首字母大写，姓名分开，双字用「-」连接
...
\defenddate{2026 年 6 月}          % 答辩日期 \today
...
\renewcommand{\todaychn}{2026 年 6 月 4 日}
\renewcommand{\todayeng}{June 4, 2026}
